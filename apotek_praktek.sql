...
INSERT INTO `detail_resep` (`id_detail`, `id_kunjungan`, `id_obat`, `jumlah`, `dosis`) VALUES
(1, 1, 1, 10, '3x1 hari'),
(2, 1, 6, 5, '1x1 hari'),
(3, 2, 2, 7, '2x1 hari'),
(4, 2, 3, 5, '1x1 hari'),
...
--
DELIMITER $$
CREATE TRIGGER `after_resep_insert` AFTER INSERT ON `detail_resep` FOR EACH ROW BEGIN
...
CREATE TABLE `dokter` (
  ...
  `tarif_konsultasi` decimal(10,2) NOT NULL,
...
INSERT INTO `dokter` (`id_dokter`, `nama`, `spesialisasi`, `no_lisensi`, `tarif_konsultasi`, `no_telp`, `email`) VALUES
(1, 'Dr. Ahmad Santoso', 'Umum', 'ID-123456789', 150000.00, '08123456789', 'ahmad.s@example.com'),
(2, 'Dr. Siti Rahayu', 'Anak', 'ID-987654321', 200000.00, '08234567890', 'siti.r@example.com'),
(3, 'Dr. Budi Wijaya', 'Penyakit Dalam', 'ID-456789123', 250000.00, '08345678901', 'budi.w@example.com');
...
INSERT INTO `jadwal_praktek` (`id_jadwal`, `id_dokter`, `hari`, `jam_mulai`, `jam_selesai`, `kuota`) VALUES
(1, 1, 'Senin', '08:00:00', '12:00:00', 15),
(2, 1, 'Rabu', '13:00:00', '17:00:00', 15),
(3, 2, 'Selasa', '09:00:00', '14:00:00', 10),
(4, 2, 'Kamis', '09:00:00', '14:00:00', 10),
(5, 3, 'Jumat', '10:00:00', '15:00:00', 12),
(6, 3, 'Sabtu', '08:00:00', '12:00:00', 8);
...
INSERT INTO `kunjungan` (`id_kunjungan`, `id_pasien`, `id_dokter`, `id_jadwal`, `tanggal`, `diagnosa`, `resep`, `status`, `created_at`) VALUES
(1, 1, 1, 1, '2023-10-02', 'Demam tinggi, flu', 'Paracetamol 3x1, Vitamin C', 'Selesai', '2025-06-03 05:44:38'),
(2, 2, 2, 3, '2023-10-03', 'Batuk pilek anak', 'Amoxicillin 2x1, Cetirizine 1x1', 'Selesai', '2025-06-03 05:44:38'),
(3, 3, 1, 2, '2023-10-04', 'Sakit kepala', 'Paracetamol 3x1', 'Terdaftar', '2025-06-03 05:44:38'),
(4, 4, 3, 5, '2023-10-06', 'Gastritis', 'Omeprazole 1x1', 'Selesai', '2025-06-03 05:44:38');
...
INSERT INTO `obat` (`id_obat`, `nama_obat`, `kategori`, `harga`, `stok`, `expired_date`, `satuan`) VALUES
(1, 'Paracetamol 500mg', 'Analgesik', 5000.00, 100, '2025-12-31', 'tablet'),
(2, 'Amoxicillin 500mg', 'Antibiotik', 15000.00, 50, '2024-10-15', 'kapsul'),
(3, 'Cetirizine 10mg', 'Antihistamin', 12000.00, 75, '2025-06-30', 'tablet'),
(4, 'Omeprazole 20mg', 'Antasida', 25000.00, 40, '2025-09-30', 'kapsul'),
(5, 'Salbutamol 2mg', 'Asma', 18000.00, 30, '2024-12-31', 'tablet'),
(6, 'Metformin 500mg', 'Diabetes', 22000.00, 60, '2025-11-30', 'tablet');
...
INSERT INTO `pasien` (`id_pasien`, `nama`, `alamat`, `no_telp`, `email`, `jenis_kelamin`, `tanggal_lahir`, `alergi`, `created_at`) VALUES
(1, 'Bambang Sutrisno', 'Jl. Merdeka No.10', '0811223344', 'bambang@example.com', 'Laki-laki', '1980-05-15', 'Paracetamol', '2025-06-03 05:44:38'),
(2, 'Dewi Lestari', 'Jl. Sudirman No.25', '0822334455', 'dewi@example.com', 'Perempuan', '1992-08-20', 'Amoxicillin', '2025-06-03 05:44:38'),
(3, 'Rudi Hermawan', 'Jl. Gatot Subroto No.5', '0833445566', 'rudi@example.com', 'Laki-laki', '1975-11-30', 'Tidak ada', '2025-06-03 05:44:38'),
(4, 'Anita Permata', 'Jl. Thamrin No.15', '0844556677', 'anita@example.com', 'Perempuan', '1988-03-25', 'Ibuprofen', '2025-06-03 05:44:38');
...
CREATE TABLE `transaksi` (
  ...
  `metode_pembayaran` enum('Tunai','Transfer','QRIS','Kartu') DEFAULT NULL,
...
INSERT INTO `transaksi` (`id_transaksi`, `id_kunjungan`, `total_biaya`, `metode_pembayaran`, `status_pembayaran`, `tanggal_transaksi`) VALUES
(1, 1, 310000.00, 'Tunai', 'Lunas', '2025-06-03 05:44:38'),
(2, 2, 365000.00, 'Transfer', 'Lunas', '2025-06-03 05:44:38'),
(3, 4, 500000.00, 'QRIS', 'Lunas', '2025-06-03 05:44:38');
...
ALTER TABLE `dokter`
  ...
  ADD UNIQUE KEY `no_lisensi` (`no_lisensi`);
...
ALTER TABLE `kunjungan`
  ...
  ADD KEY `idx_kunjungan_tanggal` (`tanggal`);
...
--
ALTER TABLE `jadwal_praktek`
  ADD CONSTRAINT `jadwal_praktek_ibfk_1` FOREIGN KEY (`id_dokter`) REFERENCES `dokter` (`id_dokter`) ON DELETE CASCADE;
...
ALTER TABLE `kunjungan`
  ...
  ADD CONSTRAINT `kunjungan_ibfk_3` FOREIGN KEY (`id_jadwal`) REFERENCES `jadwal_praktek` (`id_jadwal`);
