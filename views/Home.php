...
<div class="panel panel-default">
  ...
  <div class="panel-body">
	<h2 class="text-center">Sistem Informasi Apotik Uncen 2025</h2>
	   <p class="text-center">Aplikasi ini dibuat untuk data Apotik di Universitas Cenderawasih</strong></a>
