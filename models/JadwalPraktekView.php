 ...
 * Page class
 */
class JadwalPraktekView extends JadwalPraktek
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "JadwalPraktekView";
    ...
    // CSS class/style
    public string $CurrentPageName = "jadwalpraktekview";
...
// Is modal
        ...
        if (($keyValue = Get("id_jadwal") ?? Route("id_jadwal")) !== null) {
            ...
            $returnUrl = "jadwalprakteklist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("jadwalprakteklist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->id_jadwal->CurrentValue, $this->CurrentRow['id_jadwal'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "jadwalprakteklist"; // No matching record, return to list
                    } else {
