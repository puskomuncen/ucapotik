...
class PasienView extends Pasien
{
    ...
    // Page object name
    public string $PageObjName = "PasienView";
    ...
    // CSS class/style
    public string $CurrentPageName = "pasienview";
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("pasienlist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->id_pasien->CurrentValue, $this->CurrentRow['id_pasien'])) {
