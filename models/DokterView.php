...
class DokterView extends Dokter
{
    ...
    // Page object name
    public string $PageObjName = "DokterView";
    ...
    // CSS class/style
    public string $CurrentPageName = "dokterview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("id_dokter") ?? Route("id_dokter")) !== null) {
            $this->RecKey["id_dokter"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("id_dokter") ?? Route("id_dokter")) !== null) {
            ...
            $this->RecKey["id_dokter"] = $this->id_dokter->QueryStringValue;
        } elseif (Post("id_dokter") !== null) {
            $this->id_dokter->setFormValue(Post("id_dokter"));
            $this->RecKey["id_dokter"] = $this->id_dokter->FormValue;
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("dokterlist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->id_dokter->CurrentValue, $this->CurrentRow['id_dokter'])) {
