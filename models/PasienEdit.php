...
class PasienEdit extends Pasien
{
    ...
    // Page object name
    public string $PageObjName = "PasienEdit";
    ...
    // CSS class/style
    public string $CurrentPageName = "pasienedit";
...
// Get upload files
    ...
    protected function getEditRow(array $oldRow): array
    {
        ...
        // alergi
        $this->alergi->setDbValueDef($newRow, $this->alergi->CurrentValue, $this->alergi->ReadOnly);
    ...
    protected function restoreEditFormFromRow(array $row): void
    {
        ...
        if (isset($row['alergi'])) { // alergi
            $this->alergi->CurrentValue = $row['alergi'];
        }
