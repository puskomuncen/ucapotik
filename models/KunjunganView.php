 ...
 * Page class
 */
class KunjunganView extends Kunjungan
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "KunjunganView";
    ...
    // CSS class/style
    public string $CurrentPageName = "kunjunganview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("id_kunjungan") ?? Route("id_kunjungan")) !== null) {
            $this->RecKey["id_kunjungan"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("id_kunjungan") ?? Route("id_kunjungan")) !== null) {
            ...
            $this->RecKey["id_kunjungan"] = $this->id_kunjungan->QueryStringValue;
        } elseif (Post("id_kunjungan") !== null) {
            $this->id_kunjungan->setFormValue(Post("id_kunjungan"));
            $this->RecKey["id_kunjungan"] = $this->id_kunjungan->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->id_kunjungan->setQueryStringValue($keyValue);
            $this->RecKey["id_kunjungan"] = $this->id_kunjungan->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "kunjunganlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("kunjunganlist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->id_kunjungan->CurrentValue, $this->CurrentRow['id_kunjungan'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "kunjunganlist"; // No matching record, return to list
                    } else {
