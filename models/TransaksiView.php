 ...
 * Page class
 */
class TransaksiView extends Transaksi
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "TransaksiView";
    ...
    // CSS class/style
    public string $CurrentPageName = "transaksiview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("id_transaksi") ?? Route("id_transaksi")) !== null) {
            $this->RecKey["id_transaksi"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("id_transaksi") ?? Route("id_transaksi")) !== null) {
            ...
            $this->RecKey["id_transaksi"] = $this->id_transaksi->QueryStringValue;
        } elseif (Post("id_transaksi") !== null) {
            $this->id_transaksi->setFormValue(Post("id_transaksi"));
            $this->RecKey["id_transaksi"] = $this->id_transaksi->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->id_transaksi->setQueryStringValue($keyValue);
            $this->RecKey["id_transaksi"] = $this->id_transaksi->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "transaksilist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("transaksilist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->id_transaksi->CurrentValue, $this->CurrentRow['id_transaksi'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "transaksilist"; // No matching record, return to list
                    } else {
