 ...
 * Page class
 */
class DetailResepView extends DetailResep
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "DetailResepView";
    ...
    // CSS class/style
    public string $CurrentPageName = "detailresepview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("id_detail") ?? Route("id_detail")) !== null) {
            $this->RecKey["id_detail"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("id_detail") ?? Route("id_detail")) !== null) {
            ...
            $returnUrl = "detailreseplist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("detailreseplist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->id_detail->CurrentValue, $this->CurrentRow['id_detail'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "detailreseplist"; // No matching record, return to list
                    } else {
