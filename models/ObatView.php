...
class ObatView extends Obat
{
    ...
    // Page object name
    public string $PageObjName = "ObatView";
    ...
    // CSS class/style
    public string $CurrentPageName = "obatview";
...
// Is modal
        ...
        if (($keyValue = Get("id_obat") ?? Route("id_obat")) !== null) {
            ...
            $returnUrl = "obatlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("obatlist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->id_obat->CurrentValue, $this->CurrentRow['id_obat'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "obatlist"; // No matching record, return to list
                    } else {
