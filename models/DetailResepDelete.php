 ...
 * Page class
 */
class DetailResepDelete extends DetailResep
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "DetailResepDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "detailresepdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("detailreseplist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("detailreseplist"); // Return to list
                return;
            }
        }
