 ...
 * Page class
 */
class JadwalPraktekDelete extends JadwalPraktek
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "JadwalPraktekDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "jadwalpraktekdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("jadwalprakteklist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("jadwalprakteklist"); // Return to list
                return;
            }
        }
