 ...
 * Page class
 */
class KunjunganDelete extends Kunjungan
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "KunjunganDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "kunjungandelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("kunjunganlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("kunjunganlist"); // Return to list
                return;
            }
        }
