...
class ObatDelete extends Obat
{
    ...
    // Page object name
    public string $PageObjName = "ObatDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "obatdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("obatlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("obatlist"); // Return to list
                return;
            }
        }
