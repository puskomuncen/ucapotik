...
class ObatAdd extends Obat
{
    ...
    // Page object name
    public string $PageObjName = "ObatAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "obatadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "obatview") {
...
// Get upload files
    ...
    {
        $this->satuan->DefaultValue = $this->satuan->getDefault(); // PHP
        $this->satuan->OldValue = $this->satuan->DefaultValue;
    }
    ...
    protected function loadFormValues(): void
    {
        ...
        $val = $this->hasFormValue("id_obat") ? $this->getFormValue("id_obat") : $this->getFormValue("x_id_obat");
    }
    ...
    protected function getAddRow(): array
    {
        ...
        // nama_obat
        $this->nama_obat->setDbValueDef($newRow, $this->nama_obat->CurrentValue, false);

        // kategori
        $this->kategori->setDbValueDef($newRow, $this->kategori->CurrentValue, false);

        // harga
        $this->harga->setDbValueDef($newRow, $this->harga->CurrentValue, false);

        // stok
        $this->stok->setDbValueDef($newRow, $this->stok->CurrentValue, false);

        // expired_date
        $this->expired_date->setDbValueDef($newRow, UnFormatDateTime($this->expired_date->CurrentValue, $this->expired_date->formatPattern()), false);

        // satuan
        $this->satuan->setDbValueDef($newRow, $this->satuan->CurrentValue, strval($this->satuan->CurrentValue) == "");
        return $newRow;
    }
