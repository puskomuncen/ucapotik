 ...
 * Page class
 */
class TransaksiDelete extends Transaksi
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "TransaksiDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "transaksidelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("transaksilist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("transaksilist"); // Return to list
                return;
            }
        }
