...
return [
    ...
    "detail_resep" => \DI\autowire(DetailResep::class),
    "dokter" => \DI\autowire(Dokter::class),
    "jadwal_praktek" => \DI\autowire(JadwalPraktek::class),
    "kunjungan" => \DI\autowire(Kunjungan::class),
    "obat" => \DI\autowire(Obat::class),
    "pasien" => \DI\autowire(Pasien::class),
    "transaksi" => \DI\autowire(Transaksi::class),
